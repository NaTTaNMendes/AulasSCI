...
var
  frCadastroAntigo: TfrCadastroAntigo;

implementation

{$R *.dfm}

procedure TfrCadastroAntigo.btExcluirClick(Sender: TObject);
begin
...
procedure TfrCadastroAntigo.btExportarClick(Sender: TObject);
var
...
procedure TfrCadastroAntigo.btLimparClick(Sender: TObject);
begin
  pLimparTela;
  btExcluir.Enabled := False;
end;

procedure TfrCadastroAntigo.btSalvarClick(Sender: TObject);
var
...
procedure TfrCadastroAntigo.cbPessoaChange(Sender: TObject);
begin
...
procedure TfrCadastroAntigo.edCodigoExit(Sender: TObject);
begin
  if (edCodigo.Text <> '') then
     begin
       try
...
function TfrCadastroAntigo.fCalcularCNPJ(prEntrada: String): Integer;
var
...
function TfrCadastroAntigo.fCalcularCPF(prEntrada: String): Integer;
var
  wIncrementador, wSoma, wCount, wNumeroTemporario, wResto : Integer;
begin
  wIncrementador := 2;
...
function TfrCadastroAntigo.fDiretorio: String;
begin
  Result := 'C:\Users\prog28\Desktop\Dados';
end;

procedure TfrCadastroAntigo.FormShow(Sender: TObject);
begin
  // Cria o CDS
...
function TfrCadastroAntigo.fVerificarCPFCNPJ(prEntrada : String): Boolean;
var
...
procedure TfrCadastroAntigo.grDadosTitleClick(Column: TColumn);
begin
...
procedure TfrCadastroAntigo.pLimparTela;
begin
  edCodigo.Clear;
  edCPF.Clear;
  edNome.Clear;
